...
int is_wraith_pl(object *op) {
    return op != NULL && op->type == PLAYER && op->arch != NULL && op->contr && op->contr->is_wraith;
}
...
int is_old_wraith_pl(object *op) {
    return op != NULL && op->type == PLAYER && op->arch != NULL && op->contr && op->contr->is_old_wraith && !is_wraith_pl(op);
}
