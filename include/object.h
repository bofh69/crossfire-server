...
struct object {
    ...
    uint8_t       sound_chance;   /**< Probability, 1 to 100, of the object emitting a sound.
                                    * If the chance is greater than 200,
                                    * assume we wanted negative and override no chance of sound. */
