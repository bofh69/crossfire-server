...
extern mapstruct *generate_random_map(const char *OutFileName, RMParms *RP, char **use_layout, sstring reset_group);
...
extern object *place_chest(int treasureoptions, int x, int y, mapstruct *map, int n_treasures, RMParms *RP);
