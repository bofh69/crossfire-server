...
extern int save_map_to_stream(mapstruct *m, int flag, FILE *fp, FILE *fp2);
...
extern void object_copy_no_speed(const object *src_ob, object *dest_ob);
extern void object_copy(const object *src_ob, object *dest_ob);
extern void object_copy_with_inv(const object *src_ob, object *dest_ob, bool update_speed);
...
extern sstring object_get_value(const object *op, const char *const key);
extern bool object_value_set(const object *op, const char *const key);
extern bool object_value_set_shared(const object *op, sstring key);
...
extern void player_set_dragon_title(struct player *pl, int level, const char *attack, int skin_resist);
extern void player_get_title(const struct player *pl, char *buf, size_t bufsize);
extern int player_has_own_title(const struct player *pl);
extern const char *player_get_own_title(const struct player *pl);
extern void player_set_own_title(struct player *pl, const char *title);
...
extern int load_object(FILE *fp, object *op, int bufstate, int map_flags, bool artifact_init);
extern int load_object_from_reader(BufferReader *reader, object *op, int map_flags, bool arch_init, bool artifact_init);
