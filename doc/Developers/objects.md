...
The message structure in a monster may contain multiple of the following blocks:
@match <key>|<key>[...]
[text]
...
in the middle of the message's text (though easier to put'em at bottom).
...
a. Wildcard Character
   ...
   http://sf.net/tracker/index.php?func=detail&aid=1778380&group_id=13833&atid=113833
   ----------------------------------------------------------------------------
...
See also: http://wiki.cross-fire.org/dokuwiki/doku.php/cfpython:cfdialog
...
http://wiki.cross-fire.org/doku.php/dev:object_types contains a wiki version of
...
642		inorganic - refined (true lead, mercury, etc)
645		smithing intermediate products
...
The treasures are kept in LIBDIR/crossfire.trs.  Their format is:
...
Ref: http://wiki.cross-fire.org/doku.php/dev:shared_strings
