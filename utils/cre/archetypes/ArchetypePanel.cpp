...
ArchetypePanel::ArchetypePanel(CREMapInformationManager* store, ResourcesManager* resources, QWidget* parent) : CRETPanel(parent)
{
    Q_ASSERT(store);
    myStore = store;
...
void ArchetypePanel::setItem(archt* archetype)
{
