...
static void set_wsport(const char *val) {
...
static struct Command_Line_Options options[] = {
     ...
     * initialize any data.
     */
    { "-conf", 1, 1, (cmdlinefunc_args0)set_confdir },
    { "-d", 0, 1, (cmdlinefunc_args0)set_debug },
    { "-data", 1, 1, (cmdlinefunc_args0)set_datadir },
    { "-disable-plugin", 1, 1, (cmdlinefunc_args0)set_disable_plugin },
    { "-disable-module", 1, 1, (cmdlinefunc_args0)set_disable_module },
    { "-enable-module", 1, 1, (cmdlinefunc_args0)set_enable_module },
    { "-list-modules", 0, 1, (cmdlinefunc_args0)list_modules },
    { "-h", 0, 1, (cmdlinefunc_args0)help },
    { "-ignore-assets-errors", 0, 1, (cmdlinefunc_args0)set_ignore_assets_errors },
    { "-local", 1, 1, (cmdlinefunc_args0)set_localdir },
    { "-log", 1, 1, (cmdlinefunc_args0)set_logfile },
    { "-maps", 1, 1, (cmdlinefunc_args0)set_mapdir },
    { "-mon", 0, 1, (cmdlinefunc_args0)set_mondebug },
...
#ifdef HAVE_LIBWEBSOCKETS
    { "-wsport", 1, 2, (cmdlinefunc_args0)set_wsport },
#endif

    /** Start of pass 3 information. In theory, by pass 3, all data paths
     * and defaults should have been set up.
     */
    { "-m", 0, 3, (cmdlinefunc_args0)set_dumpmon1 },
    { "-m2", 0, 3, (cmdlinefunc_args0)set_dumpmon2 },
    { "-m3", 0, 3, (cmdlinefunc_args0)set_dumpmon3 },
    { "-m4", 0, 3, (cmdlinefunc_args0)set_dumpmon4 },
    { "-m5", 0, 3, (cmdlinefunc_args0)set_dumpmon5 },
    { "-m6", 0, 3, (cmdlinefunc_args0)set_dumpmon6 },
    { "-m7", 0, 3, (cmdlinefunc_args0)set_dumpmon7 },
    { "-m8", 0, 3, (cmdlinefunc_args0)set_dumpmon8 },
    { "-m9", 0, 3, (cmdlinefunc_args0)set_dumpmon9 },
    { "-mt", 1, 3, (cmdlinefunc_args0)set_dumpmont },
    { "-mexp", 0, 3, (cmdlinefunc_args0)dump_experience },
    { "-mq", 0, 3, (cmdlinefunc_args0)dump_quests },
